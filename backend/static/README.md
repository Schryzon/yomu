# yōmu! Web Demo & Assets

This directory contains the source code for the yōmu! landing page and interactive web demo.
...
- **Performance**: Uses CSS hardware acceleration for animations to ensure 60fps even on mobile devices.
- **Theme Awareness**: Integrated with the system-wide yōmu! design tokens.
